...
//   /// Google Login (force show account picker)
//   static Future<Map<String, dynamic>?> signInWithGoogle() async {
//     try {
//       log("fgsdhjghsdkghksfdj");
//       // Sign out any existing account
//       await _googleSignIn.signOut();

//       // Disconnect may fail if no account exists → safe try-catch
//       try {
...
//       // Now show Gmail account chooser
