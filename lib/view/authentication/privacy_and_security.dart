...
bool mileageSwitch = false;
  ...
  child: CupertinoSwitch(
    ...
    trackColor: AppColor.toggleColor,
                ...
                Padding(
                  ...
                  child: Text(
                    AppLanguage.profileprivacyText[language],
                    textAlign: TextAlign.left,
                    style: TextStyle(
                      fontFamily: AppFont.fontFamily,
                      fontSize: 18,
                  ...
                  child: Column(
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          Text(
                            AppLanguage.shareLocation[language],
                            style: const TextStyle(
                              color: AppColor.secondryColor,
                              fontSize: 16,
                              fontFamily: AppFont.fontFamily,
  ...
  scale: 0.80,
  child: CupertinoSwitch(
    value: broadenedSwitch,
    onChanged: (value) {
      setState(() {
        broadenedSwitch = value;
      });
    },
    activeColor: AppColor.pinkColor,
    thumbColor: Colors.white,
    trackColor: AppColor.toggleColor,
                      ...
                      Text(
                        AppLanguage.accessLocationText[language],
                        style: const TextStyle(
                          color: AppColor.notificationtextColor,
                          fontSize: 14,
                          fontFamily: AppFont.fontFamily,
